...
var logger$i = require('@azure/logger');
 ...
 */
const logger = logger$i.createClientLogger("identity");
/**
    ...
    isAvailable(identityClient, resource, clientId, getTokenOptions) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                logger$7.info(formatError(`Error when creating the WebResource for the IMDS endpoint: ${err.message}`));
                span.setStatus({
                    code: api.CanonicalCode.UNKNOWN,
                    message: err.message
                });
    ...
    acquireTokenFromBrowser(scopeArray) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => tslib.__awaiter(this, void 0, void 0, function* () {
                ...
                listen = app.listen(this.port, () => logger$f.info(`Msal Node Auth Code Sample app listening on port ${this.port}!`));
    ...
    getToken(scopes, options) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                logger$h.getToken.info(formatError(err));
                throw err;
            }
            finally {
                span.end();
